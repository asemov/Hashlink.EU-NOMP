...
Handle<Value> tris(const Arguments& args) {
    HandleScope scope;
    ...
    tris_hash(input, output, input_len);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("tris"), FunctionTemplate::New(tris)->GetFunction());
